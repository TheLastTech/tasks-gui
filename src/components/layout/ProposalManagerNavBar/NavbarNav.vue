<template>
  <d-navbar-nav class="border-left flex-row">
    ...
    <li class="nav-item dropdown">
      <a class="d-none d-sm-block  nav-link dropdown-toggle text-nowrap px-3" v-d-toggle.user-actions>
      ...
      <d-collapse id="user-actions" class="dropdown-menu dropdown-menu-small">
        ...
        <d-dropdown-item><i class="material-icons">&#xE2C7;</i> My Projects (Manager) </d-dropdown-item>
        <d-dropdown-item><i class="material-icons">&#xE896;</i> My Projects (Developer) </d-dropdown-item>
        <d-dropdown-divider />
