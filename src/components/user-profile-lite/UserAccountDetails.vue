            ...
            <d-form>
              <d-form-row>
                ...
                <d-col md="6" class="form-group">
                  ...
                  <d-form-input type="text" id="feFirstName" placeholder="First Name" value="Ari" />
                </d-col>
              ...
              <d-form-row>
                ...
                <d-col md="6" class="form-group">
                  ...
                  <d-form-input type="email" id="feEmail" placeholder="Email Address" value="tenshihan@gmail.com" />
                </d-col>
