  ...
  <d-card class="card mb-3">
    <div :class="QADepthClass" v-for="(QuestionLine,Index) in PledgeQA" :key="Index">
      ...
      <div class="media-body">
        <smaller-qa-credit-line :user="QuestionLine.User"/>
...
<script>
  ...
  import LargerQaCreditLine from './LargerQaCreditLine.vue';
  import SmallerQaCreditLine from './SmallerQaCreditLine.vue';
  ...
  export default {
    ...
    name: 'q-a-section',
    components: {
      SmallerQaCreditLine, LargerQaCreditLine, ReplyToQa, QAPreview,
    },
    props: {
